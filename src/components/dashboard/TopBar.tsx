  ...
  return (
    <header className="bg-white border-b border-gray-100 px-6 py-3 flex items-center justify-between sticky top-0 z-40">
      ...
      <div className="flex items-center gap-4">
        ...
        <span className="text-xs bg-blue-50 text-blue-600 px-3 py-1 rounded-full font-medium">School Admin</span>
        ...
        <button onClick={logout} className="p-2 hover:bg-gray-50 rounded-lg transition" title="Logout">
          <svg className="w-5 h-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
